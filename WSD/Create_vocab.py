...
def createVocab(max_vocab_size):
    ...
    with open('util/vocab_'+word+'_sentences.txt', 'wb') as handle:
        pickle.dump(d, handle)
    with open("util/"+word+"_index_2_word_map.txt",'wb') as handle2:
    ...
    with open('util/vocab_'+word+'_senses.txt', 'wb') as handle1:
        pickle.dump(d1, handle1)
    with open("util/"+word+"_index_2_word_senses_map.txt",'wb') as handle3:
